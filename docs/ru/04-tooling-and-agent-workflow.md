...
| Точка входа в профилирование | `uv run --script scripts/profiler_review.py` |
...
| `scripts/profiler_review.py` | запуск одного режима профилирования против одного benchmark-binary и scenario |
